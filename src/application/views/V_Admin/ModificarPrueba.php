...
<!--Formulario-->
<form action="modificarPrueba" id="updateServicio" method="POST">
	
	  
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Nombre Servicio</label>
    <div class="col-sm-10">
              <input type="text" class="form-control" name="name" id="name" value="'.$datos[0]['nombrePrueba'].'"  placeholder="Nombre del Tratamiento o Prueba" onblur="validarNombre()">
      <p id="errorName"></p>
    </div>
  </div>
   ...
   <div class="form-group row">
    <label class="col-sm-2 col-form-label">Descripción del servicio</label>
     <div class="col-sm-10">
           <textarea class="form-control" name="texto"  id="texto"  onblur="validarTexto()" required>'.$datos[0]['descripcionPrueba'].'" </textarea>
    	<p id="errorText"></p>
      </div>
   </div>
