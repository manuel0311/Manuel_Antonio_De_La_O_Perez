...
<div class="col">
<!--Formulario-->
<form action="panelPrueba"  method="POST">
  <div class="form-group row">
  </div>';

echo' <p>Listado Prueba</p>
<div class="table-wrapper-scroll-y my-custom-scrollbar">
  ...
  <table class="table table-bordered table-striped mb-0">
    ...
    <tbody>';
     foreach ($prueba as $datos){
     	echo'
		  <tr>
			<th scope="row"><input type="radio" name="prueba" value="'.$datos['idPrueba'].'"></th>
			<td>'.$datos['nombrePrueba'].'</td>
			<td>'.$datos['descripcionPrueba'].'</td>
			<td>'.$datos['precio'].'</td>
		  </tr>';
  ...
  <div class="form-group row">
    <div class="col-sm-10">
     ...
     <input class="btn btn-primary" data-toggle="modal" data-target="#eliminar" type="button" value="Eliminar Prueba">
    </div>
  </div>
