...
<form action="Paso_tres" id="formularioAdministrador" method="POST">
  ...
  <div class="form-group row">
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="mail" class="form-control" name="mail" maxlength="100"  id="mail" onblur="validarCorreo()" placeholder="Introduce correo Eléctronico" required>
      <p id="errorMail"></p>
    </div>
  </div>
   ...
   <div class="form-group row">
    <label class="col-sm-2 col-form-label">Contraseña</label>
     <div class="col-sm-10">
      <input type="password" name="password" class="form-control" id="password" placeholder="Introduce Cotraseña" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Repetir Contraseña</label>
     <div class="col-sm-10">
      <input type="password" name="password2" class="form-control" id="password2"  onblur="contraseniaValida()" placeholder="Introduce Cotraseña" required>
