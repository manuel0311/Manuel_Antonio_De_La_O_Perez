...
<div class="col">
<!--Formulario-->
<form action="opcionesPresupuesto"  method="POST">
...
echo' <p>Muestra todos los presupuesto disponibles y NO archivados.</p>
 <table class="table">
  <thead>
    <tr>
 ...
 echo' </tbody>
  ...
  <div class="form-group row">
    <div class="col-sm-10">
      <input type="submit" class="btn btn-primary"  name="consultar" value="Consulta">
