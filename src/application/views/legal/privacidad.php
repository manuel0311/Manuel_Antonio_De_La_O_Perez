...
<body>
        ...
        <div class="container">
          <div class="row-fluid bg-dark justify-content-center mt-3 mb-3">
            <h1 class="text-capitalize text-white">Política de Privacidad</h1>
        </div>   
 		<div class="ng-binding">
 <h3>Responsable – ¿quién es el responsable del tratamiento de los datos?</h3>
           
<strong>Identidad:</strong> Clínica Higea Dental S.L.<br>
<strong>Domicilio social:</strong> Calle Marques de La Vega ,10 ,Puebla de la Calzada(Badajoz) 06490<br>
<strong class="ng-binding">NIF:</strong> B06532360<br>
...
<strong>Nombre del dominio:</strong> web<br>
  ...
  <p>En cumplimiento de lo dispuesto en el Reglamento Europeo 2016/679 General de Protección de Datos, te informamos de que trataremos los datos que nos facilitas para:</p>
    <ul>
      ...
      <li class="ng-binding">Remitir periódicamente comunicaciones sobre servicios, eventos y noticias relacionadas con las actividades desarrolladas por Clínica Higea Dental S.L., por cualquier medio (teléfono, correo postal o email), salvo que se indique lo contrario o el usuario se oponga o revoque su consentimiento.</li>
  ...
  <p class="ng-binding">Derivada de las finalidades antes mencionadas, en Clínica Higea Dental S.L.  gestionamos las siguientes categorías de datos:</p>
  <ul>
    <li>Datos identificativos</li>
    <li>Metadatos de comunicaciones electrónicas</li>
    <li class="ng-binding">Datos de información comercial. En caso de que el usuario facilite datos de terceros, manifiesta contar con el consentimiento de estos y se compromete a trasladarle la información contenida en esta cláusula, eximiendo a Clínica Higea Dental S.L. de cualquier responsabilidad en este sentido.</li>
    <li class="ng-binding">No obstante,  Clínica Higea Dental S.L.  podrá llevar a cabo las verificaciones para constatar este hecho, adoptando las medidas de diligencia debida que correspondan, conforme a la normativa de protección de datos.</li>
  </ul>
...
<ul>
  <li class="ng-binding">Encriptación de las comunicaciones entre el dispositivo del usuario y los servidores de Clínica Higea Dental S.L. </li>
  <li class="ng-binding">Encriptación de la información en los propios servidores de Clínica Higea Dental S.L.</li>
  <li>Otras medidas que eviten el acceso a los datos del usuario por parte de terceros.</li>
  <li class="ng-binding">En aquellos casos en los que Clínica Higea Dental S.L.  cuente con prestadores de servicio para el mantenimiento de la plataforma que se encuentren fuera de la Unión Europea, estas trasferencias internacionales se hayan regularizadas atendiendo al compromiso de Clínica Higea Dental S.L.  con la protección, integridad y seguridad de los datos personales de los usuarios.</li>
</ul>            

<h3>Derechos – ¿Cuáles son tus derechos cuando nos facilitas tus datos y cómo puedes ejercerlos?</h3>
<p class="ng-binding">
 Tienes derecho a obtener confirmación sobre si en Clínica Higea Dental S.L. estamos tratando datos personales que te conciernan, o no.<br>
...
En determinadas circunstancias y por motivos relacionados con tu situación particular, podrás oponerte al tratamiento de tus datos. Clínica Higea Dental S.L.  dejará de tratar los datos, salvo por motivos legítimos imperiosos, o el ejercicio o la defensa de posibles reclamaciones.<br><br>
...
Si deseas hacer uso de cualquiera de tus derechos puede dirigirse a <a href="mailto:contacto@higea-dental.com" class="ng-binding">contacto@higea-dental.com</a>. <br><br>
...
<p class="ng-binding">
   Clínica Higea Dental S.L. podrá modificar la presente Política de Privacidad en cualquier momento, siendo publicadas las sucesivas versiones en el Sitio Web. En cualquier caso, Clínica Higea Dental S.L. comunicará con previo aviso las modificaciones de la presente política que afecten a los usuarios a fin de que puedan aceptar las mismas. <br><br>
La presente Política de Privacidad se encuentra actualizada a fecha 27/12/2018 Clínica Higea Dental S.L.  (España). Reservados todos los derechos.
 <br><br>
Si lo deseas también puedes consultar nuestra  <strong><a href="'.base_url('Politica_Cookies').'">Política de Cookies</a></strong>
