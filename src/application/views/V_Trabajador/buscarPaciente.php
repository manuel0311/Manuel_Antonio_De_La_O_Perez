...
<div class="row">
		<div class="col-xs-12 col-sm-6 .col-lg-8">
			<img src="'.base_url("assets/Media/img/Paciente.jpg").'"  class="img-fluid" alt="dentista con el uniforme de trabajo">
</div>

<div class="col" style="text-align: center">
<h3>Introduce el DNI del Paciente .</h3>';
...
echo'
<!--Formulario-->
<form action="consultarPaciente" method="post" id="seleccionarUsuario">
